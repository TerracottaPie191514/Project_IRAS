...
Rps@sam_data$PAM = pam.out
sample_data(Rps)$PAM = as.factor(sample_data(Rps)$PAM)
...
# PCoA for ARG data, BC with DMM, euclidian ( make sure tse_dmn is on right taxonomic level)
